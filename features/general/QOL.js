...
registerWhen(register("chat", (dings1, players, dings2, games, event) => {
    cancel(event);
}).setCriteria("&a&aYou tipped ${dings1} ${players} in ${dings2} different ${games}"), () => settings.hideTippedPlayers);
