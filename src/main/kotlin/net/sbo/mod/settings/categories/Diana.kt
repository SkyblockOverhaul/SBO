...
object Diana : CategoryKt("Diana") {
    ...
    var medalOtherClipDurationSeconds by int(30) {
        this.range = 1..120
        this.slider = true
        this.name = Literal("Other Drops Clip Duration (seconds)")
        this.description = Literal("How long Medal clips should be for other Diana drops")
    }

    var medalOtherCaptureDelayMs by int(10000) {
        this.range = 0..60000
        this.slider = true
        this.name = Literal("Other Drops Capture Delay (ms)")
        this.description = Literal("Delay before Medal captures clips for other Diana drops")
    }
}
