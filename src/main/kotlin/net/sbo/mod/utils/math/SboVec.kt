...
data class SboVec(var x: Double, var y: Double, var z: Double) {
    ...
    operator fun plus(other: SboVec): SboVec = SboVec(this.x + other.x, this.y + other.y, this.z + other.z)

    operator fun minus(other: SboVec): SboVec = SboVec(this.x - other.x, this.y - other.y, this.z - other.z)

    operator fun times(d: Double): SboVec = SboVec(this.x * d, this.y * d, this.z * d)

    fun down(amount: Double = 1.0): SboVec = this.copy(y = this.y - amount)

    fun up(amount: Double = 1.0): SboVec = this.copy(y = this.y + amount)
    ...
    fun center(): SboVec = SboVec(this.x + 0.5, this.y + 0.5, this.z + 0.5)
    ...
    companion object {
        ...
        fun Vec3.toSboVec(): SboVec = SboVec(this.x, this.y, this.z)

        fun BlockPos.toSboVec(): SboVec = SboVec(this.x.toDouble(), this.y.toDouble(), this.z.toDouble())
    }
}
