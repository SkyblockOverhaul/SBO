...
const webbed = {'name': "webbed",'coords': [{'x': 0, 'y': 1}, {'x': 1, 'y': 2}, {'x': 2, 'y': 3}, {'x': 3, 'y': 3}, {'x': 3, 'y': 2}, {'x': 3, 'y': 1}, {'x': 3, 'y': 0}, {'x': 4, 'y': 3}, {'x': 5, 'y': 2}, {'x': 6, 'y': 1}]}
...
const tuskMirrored1 = {'name': "tuskMirrored",'coords': [{'x': 2, 'y': 0}, {'x': 3, 'y': 0}, {'x': 4, 'y': 0}, {'x': 1, 'y': 1}, {'x': 0, 'y': 2}, {'x': 1, 'y': 3}, {'x': 3, 'y': 3}, {'x': 2, 'y': 4}]}
const tuskMirrored2 = {'name': "tuskMirrored",'coords': [{'x': 0, 'y': 0}, {'x': 0, 'y': 1}, {'x': 3, 'y': 1}, {'x': 0, 'y': 2}, {'x': 4, 'y': 2}, {'x': 1, 'y': 3}, {'x': 3, 'y': 3}, {'x': 2, 'y': 4}]}
const tuskMirrored3 = {'name': "tuskMirrored",'coords': [{'x': 2, 'y': 4}, {'x': 1, 'y': 4}, {'x': 0, 'y': 4}, {'x': 3, 'y': 3}, {'x': 4, 'y': 2}, {'x': 3, 'y': 1}, {'x': 1, 'y': 1}, {'x': 2, 'y': 0}]}
const tuskMirrored4 = {'name': "tuskMirrored",'coords': [{'x': 4, 'y': 4}, {'x': 4, 'y': 3}, {'x': 1, 'y': 3}, {'x': 4, 'y': 2}, {'x': 0, 'y': 2}, {'x': 3, 'y': 1}, {'x': 1, 'y': 1}, {'x': 2, 'y': 0}]}
...
const helixMirrored1 = {'name': "helixMirrored",'coords': [{'x': 0, 'y': 0}, {'x': 1, 'y': 0}, {'x': 2, 'y': 0}, {'x': 3, 'y': 0}, {'x': 0, 'y': 1}, {'x': 3, 'y': 1}, {'x': 0, 'y': 2}, {'x': 1, 'y': 2}, {'x': 3, 'y': 2}, {'x': 3, 'y': 3}, {'x': 0, 'y': 4}, {'x': 1, 'y': 4}, {'x': 2, 'y': 4}, {'x': 3, 'y': 4}]}
const helixMirrored2 = {'name': "helixMirrored",'coords': [{'x': 0, 'y': 0}, {'x': 2, 'y': 0}, {'x': 3, 'y': 0}, {'x': 4, 'y': 0} ,{'x': 0, 'y': 1}, {'x': 2, 'y': 1}, {'x': 4, 'y': 1}, {'x': 0, 'y': 2}, {'x': 4, 'y': 2}, {'x': 0, 'y': 3}, {'x': 1, 'y': 3}, {'x': 2, 'y': 3}, {'x': 3, 'y': 3}, {'x': 4, 'y': 3}]}
const helixMirrored3 = {'name': "helixMirrored",'coords': [{'x': 3, 'y': 4}, {'x': 2, 'y': 4}, {'x': 1, 'y': 4}, {'x': 0, 'y': 4}, {'x': 3, 'y': 3}, {'x': 0, 'y': 3}, {'x': 3, 'y': 2}, {'x': 2, 'y': 2}, {'x': 0, 'y': 2}, {'x': 0, 'y': 1}, {'x': 3, 'y': 0}, {'x': 2, 'y': 0}, {'x': 1, 'y': 0}, {'x': 0, 'y': 0}]}
const helixMirrored4 = {'name': "helixMirrored",'coords': [{'x': 4, 'y': 3}, {'x': 2, 'y': 3}, {'x': 1, 'y': 3}, {'x': 0, 'y': 3}, {'x': 4, 'y': 2}, {'x': 2, 'y': 2}, {'x': 0, 'y': 2}, {'x': 4, 'y': 1}, {'x': 0, 'y': 1}, {'x': 4, 'y': 0}, {'x': 3, 'y': 0}, {'x': 2, 'y': 0}, {'x': 1, 'y': 0}, {'x': 0, 'y': 0}]}
